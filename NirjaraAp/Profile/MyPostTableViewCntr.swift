...
class MyPostTableViewCntr: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblPost.dequeueReusableCell(withIdentifier: "postIdentifier", for: indexPath) as! MyPostsTableViewCell
        cell.selectionStyle = .none
        var businessData = myBusiness[indexPath.row] as! MyPostModel
        cell.mainBackground.frame = CGRect(x:10,y:10,width:view.frame.width-20,height:205)
        cell.lblPostName.frame = CGRect(x:10,y:10,width:cell.mainBackground.frame.width-20,height:25)
        ...
        cell.lblPostName.setFAText(prefixText: "", icon: .FAUsers, postfixText:" "+(businessData.business_owner_name!), size: 18)
        ...
        cell.mainBackground.addSubview(cell.lblPostName)
