...
public extension NSMutableAttributedString {
	public static func fontAwesomeAttributedString(name: String, suffix: String?, iconSize: CGFloat, suffixSize: CGFloat?) -> NSMutableAttributedString {
        ...
        var iconAttributed = NSMutableAttributedString(string: iconString, attributes: [NSAttributedStringKey.font:UIFont(name: "HelveticaNeue", size: suffixFontSize)!])
		
		// Role font awesome over the icon and size according to parameter
        iconAttributed.addAttribute(NSAttributedStringKey.font, value: UIFont.iconFontOfSize(font: "FontAwesome", fontSize: iconSize), range: NSRange(location: 0,length: 1))
